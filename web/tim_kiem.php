...
<body>
  ...
  $s = $_GET["s"];
  $result = $conn->query("SELECT * FROM san_pham WHERE ten_san_pham LIKE '%" . $s . "%'");
  ?>
  <section class="container mt-4" style="min-height: 50vh;">
    <caption>Đã tìm thấy <?= $result->num_rows ?> kết quả</caption>
