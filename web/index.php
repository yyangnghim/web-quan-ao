...
<body>
  ...
  <section class="container mt-4">
    ...
    <div class="row row-gap-4 mt-3">
      <?php
      $result = $conn->query("SELECT * FROM san_pham WHERE giam_gia > 0 LIMIT 4");
    ...
    <p class="text-center pt-5">
      <a href="san_pham_giam_gia.php">Xem tất cả <span><i class="fa-solid fa-chevron-right fs-6 ps-1"></i></span></a>
    </p>
  </section>
